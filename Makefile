...
remote.o: modules/remote.c ../../drivers/avr/ir_uart.h ../../drivers/avr/system.h modules/remote.h
	$(CC) -c $(CFLAGS) $< -o $@


# Link: create ELF output file from object files.
remotemotor.out: remotemotor.o system.o pio.o ledmat.o display.o font.o tinygl.o navswitch.o usart1.o ir_uart.o timer0.o timer.o pacer.o remote.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
